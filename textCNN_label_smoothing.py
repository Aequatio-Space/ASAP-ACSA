...
from trainFunc import train_CLS,train
from train_utils import collector,evaluateSENT,get_aspect_vector_DICT,collcate_pad_Full,ASAP_Full,CrossEntropyLoss_LS
from model import GCAE_ACSA_RL,GCAEReg_MultiConv,init_weights,TextCNN
...
input_path = ""
loss_func = CrossEntropyLoss_LS(label_smooth=0.10,class_num=5)
kernel_sizes, nums_channels, paddings = [3, 4, 5], [100, 100, 100] , [1,2,3]
#Load Data
