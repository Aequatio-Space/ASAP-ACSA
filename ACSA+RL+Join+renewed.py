...
from trainFunc import train_CLS,train_ASPECT
from train_utils import ASAP_Full,get_aspect_vector_DICT,collcate_pad_Full
from model import GCAE_ACSA,init_weights,TextCNN
...
NN.classifyFC = None
pretrained = torch.load("/Users/Charlie/Downloads/trian.tsv2022-06-04 00_55_50.pt",map_location=device)
NN.load_state_dict(state_dict=pretrained,strict=False)
NN.classifyFC = nn.Linear(sum(num_channels),num_classes)
NN.classifyFC.apply(init_weights)
